...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Google sign-in not implemented yet. Use email/password or demo.",
        variant: "default",
      });
    } catch (error) {
      toast({
  ...
  const handleLinkedInLogin = async () => {
    toast({
      ...
      description: "LinkedIn sign-in not implemented yet. Use email/password or demo.",
      variant: "default",
    });
  };
        ...
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription className="text-muted-foreground">
              Sign in to your LegalAssist AI account
            </CardDescription>
          </div>
        </CardHeader>
