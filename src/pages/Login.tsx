...
export default function Login() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Google sign-in not implemented yet. Use email/password or demo.",
        variant: "default",
      });
    } catch (error) {
      toast({
  ...
  const handleLinkedInLogin = async () => {
    toast({
      ...
      description:
        "LinkedIn sign-in not implemented yet. Use email/password or demo.",
      variant: "default",
    });
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        ...
        <div
          className="absolute top-40 right-32 w-1 h-1 rounded-full bg-neural-secondary animate-pulse-node"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute bottom-32 left-1/3 w-1.5 h-1.5 rounded-full bg-neural-glow animate-pulse-node"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-40 right-20 w-1 h-1 rounded-full bg-neural-primary animate-pulse-node"
        ...
        <svg className="absolute inset-0 w-full h-full">
          ...
          <line
            ...
            x2="90%"
            y2="35%"
            stroke="hsl(var(--neural-secondary))"
            strokeWidth="1"
            opacity="0.3"
            className="animate-flow-data"
            style={{ animationDelay: "1s" }}
        ...
        <CardHeader className="text-center space-y-4">
          ...
          <div>
            ...
            <CardDescription className="text-muted-foreground">
              Sign in to your DocksTalk account
            </CardDescription>
          </div>
        </CardHeader>
