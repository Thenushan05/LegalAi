  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        ...
        <nav className="p-3 border-b border-sidebar-border flex-shrink-0">
          {/* Action Buttons */}
            ...
            {sidebarItems.map((item) => {
              ...
              const navContent = (
                <NavLink
                  ...
                  style={
                    item.isActive ? { borderLeftColor: "hsl(var(--primary))" } : undefined
                  }
                >
                  ...
                  {item.isActive && (
                    <div
                      className="absolute right-2 w-1 h-1 rounded-full animate-pulse bg-primary"
                    />
                  )}
                </NavLink>
              );
            ...
            <div className="p-3 border-b border-sidebar-border">
              ...
              <div className="space-y-2">
                {recentChats.map((chat) => (
                  <div
                    key={chat.id}
                    className="group flex items-center gap-2 p-2 rounded-lg hover:bg-sidebar-accent cursor-pointer transition-all duration-200"
                  >
                    <div
            ...
            <div className="p-3 border-b border-sidebar-border">
              ...
              <div className="space-y-2">
                {quickActions.map((action) => (
                  <div
                    key={action.title}
                    className="p-2 rounded-lg hover:bg-sidebar-accent cursor-pointer transition-all duration-200 group"
                  >
                    <div className="flex items-center gap-2">
                      <div
                        className="w-8 h-8 rounded-lg flex items-center justify-center group-hover:opacity-90 transition-colors bg-primary/10"
                      >
            ...
            <div className="p-3 border-b border-sidebar-border">
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">
                  Click on highlighted text to get instant legal insights and
                  suggestions.
                </p>
              </div>
            </div>
