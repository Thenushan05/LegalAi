  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        highlight: {
          favorable: "hsl(var(--highlight-favorable))",
          neutral: "hsl(var(--highlight-neutral))",
          risky: "hsl(var(--highlight-risky))",
        },
        sidebar: {
      ...
      boxShadow: {
        card: "0 4px 20px -4px hsl(220 9% 46% / 0.1)",
        "card-hover": "0 8px 32px -8px hsl(var(--primary) / 0.2)",
        glow: "0 0 20px hsl(var(--primary) / 0.3)",
        neural: "0 0 40px hsl(var(--neural-primary) / 0.3)",
      },
    },
  },
